...
Author: Ifa Namee
Date: 11/26/2023
purpose: Al Sweigart Automate book Chapter 11
...
def main():
    ...
    str_url = input("Enter the URL of the poem: ")
    # Validate the URL
    if not str_url.startswith("http"):
        print("Invalid URL. Please enter a valid URL. Which start with 'http:...")
        return main()
    ...
    try:
        ...
        while True:
            ...
            if str_input == "y" or str_input == "yes":  # If yes display source html /// for some reason if I use .lower, it does not work.
                ...
                print(
                    "Invalid input. Please try again.")  # If no matching option detected, display error message and ask again.
        # Extract Poem
...
def restart():  # Ask user to restart program.
    again = input("\nWould you like to Restart program? Enter 'y' or 'n': ")
    if again == 'n':
